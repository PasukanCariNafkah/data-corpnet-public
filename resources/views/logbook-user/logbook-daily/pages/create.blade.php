...
<div class="container">
    ...
    <div class="card border-o shadow rounded ">
        <div class="card-body">
            <form action="{{route('logbook-user-daily.storefromlogbook')}}" method="post" id="submit-form">
                @method("POST")
                @csrf
                <div class="form-row">
                    <div class="form-group col-md-2">
                        <label for="cid">CID User</label>
                        <input type="text" value="" name="cid" id="cid" class="form-control">
                    </div>
                    <div class="form-group col-md-6">
                        <label for="name">Name of Customer</label>
                        <input type="text" readonly id="nama" class="form-control" value="">
                    </div>
                    <div class="form-group col-md-2">
                    ...
                    <div class="form-group col-md-3">
                        ...
                        <select class="form-control browser-default custom-select" name="segment_user" id="category">
                    ...
                    <div class="form-group col-md-2">
                        ...
                        <select name="impact" class="form-control browser-default custom-select" id="subcategory">
                    ...
                    <div class="form-group col-md-4 offset-md-2">
                        <a href="{{route('logbook-user-daily.index')}}"
                            class="btn btn-danger btn-md float-right">Back</a>
                    </div>
                </div>
            </form>
