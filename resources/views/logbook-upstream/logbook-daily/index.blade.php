    ...
    <div class="col-12">
        <div class="card">
            <div class="card-header">
                ...
                <a href="{{route('logbook-upstream-daily.create')}}" class="btn btn-primary rounded">Add Logbook
                    Upstream</a>
                <a href="{{route('logbook-upstream-weekly.index')}}" class="btn btn-secondary rounded">To Category
                    Logbook</a>
                <a href="{{ route('report.logbookUpstreamWeekly') }}" class="btn btn-success ml-4  float-right rounded">
                    Report Logbook Weekly
                </a>
                <a href="{{ route('report.logbookUpstreamDaily') }}" class="btn btn-info float-right rounded">
                    Report Logbook
                </a>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <a href="{{route('logbook-upstream-daily.edit', $item->id)}}"
                                    class="btn btn-success btn-sm">Edit</a>
                                <form action="{{route('logbook-upstream-daily.destroy', $item->id)}}" method="post"
