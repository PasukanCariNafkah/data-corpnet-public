...
@section('title', 'Add Logbook Upstream')
...
<div class="container">
    ...
    <div class="card border-o shadow rounded">
        <div class="card-body">
            <form action="{{route('logbook-upstream-daily.store')}}" method="post" id="submit-form">
                @method("POST")
                @csrf
                <div class="form-row">
                    <div class="form-group col-md-3">
                        ...
                        <select name="upstream" required class="form-control">
                            ...
                            <option value="{{$upstream->id}}">{{$upstream->nama}}
                                @endforeach
                        </select>
                    </div>
                    ...
                    <div class="form-group col-md-2">
                        ...
                        <select class="form-control" name="link" required>
                            <option value="Domestik">Domestik
                            </option>
                    ...
                    <div class="form-group col-md-4">
                        ...
                        <input type="text" name="ticket" class="form-control" value="{{old('ticket')}}">
                    </div>
                    ...
                    <div class="form-group col-md-4 offset-md-2">
                        ...
                        <a href="{{route('logbook-upstream-daily.index')}}" class="btn btn-danger float-right">Close</a>
                    </div>
                </div>
            </form>
        </div>
