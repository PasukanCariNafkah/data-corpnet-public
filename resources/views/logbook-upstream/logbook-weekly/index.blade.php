                ...
                <div class="row">
                    <div class="col-5">
                        <div class="card">
                            ...
                            <form action="{{route('logbook-upstream-weekly.store')}}" method="post">
                                <div class="card-body">
                                    @method("POST")
                                    @csrf
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <a class="btn btn-sm btn-primary table_style"
                                                    href="{{ route('logbook-upstream-weekly.edit', $item->id) }}"><i
                                                        class="fa fa-pencil"></i>
                                                </a>
                                                <form action="{{route('logbook-upstream-weekly.destroy', $item->id)}}"
                                                ...
                                                <ul>
                                                    ...
                                                    <ol class="ol_style">
                                                        <a class="btn btn-sm btn-primary table_style"
                                                            href="{{ route('logbook-upstream-weekly.edit', $subcategory->id) }}"><i
                                                                class="fa fa-pencil"></i>
                                                        </a>

                                                        <form
                                                            action="{{route('logbook-upstream-weekly.destroy', $subcategory->id)}}"
                                                            id="delete-form" class="d-inline" method="post">
                                                            @method('delete')
                                                            @csrf
                                                            <button type="submit" id="delete-button"
