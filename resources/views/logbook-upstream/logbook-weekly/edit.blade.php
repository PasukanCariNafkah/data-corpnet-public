...
@section('title', 'Edit Logbook Upstream Weekly')
...
<div class="container">
    ...
    <div class="card bg-light ">
        ...
        <div class="card-body">
            <form action="{{route('logbook-upstream-weekly.update', $category->id)}}" method="post" id="submit-form">
                @method("PUT")
                @csrf
                ...
                <div class="form-group">
                    <button type="submit" class="btn btn-primary rounded btn-md" id="save-button">Save
                        Changes</button>
                    <a href="{{route('logbook-upstream-weekly.index')}}" class="btn btn-secondary  float-right">Back</a>
