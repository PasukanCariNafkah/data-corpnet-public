...
@section('title', 'Logbook Network CorpNet')
            ...
            <div class="card-body">
                <div class="row">
                    <div class="col-5">
                        <div class="card">
                            <div class="card-header">
                                <h5>Add Category or Subcategory</h5>
                            </div>
                            <form action="{{route('logbook-network-weekly.store')}}" method="post">
                                <div class="card-body">
                                    @method("POST")
                                    @csrf
                    ...
                    <div class="col-7">
                        <div class="card">
                            <div class="card-header">
                                ...
                                <h5>List of Category and Sub Category</h5>
                            </div>
                            <div class="card-body">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <a class="btn btn-sm btn-primary"
                                                    href="{{ route('logbook-network-weekly.edit', $item->id) }}"><i
                                                        class="fa fa-pencil"></i>
                                                </a>

                                                <form action="{{route('logbook-network-weekly.destroy', $item->id)}}"
                                                ...
                                                <ul>
                                                    ...
                                                    <ol class="ol_style">
                                                        <a class="btn btn-sm btn-primary table_style"
                                                            href="{{ route('logbook-network-weekly.edit', $subcategory->id) }}"><i
                                                                class="fa fa-pencil"></i>
                                                        </a>
                                                        <form
                                                            action="{{route('logbook-network-weekly.destroy', $subcategory->id)}}"
                                                            id="delete-form" class="d-inline" method="post">
                                                            @method('delete')
                                                            @csrf
                                                            <button type="submit" id="delete-button"
